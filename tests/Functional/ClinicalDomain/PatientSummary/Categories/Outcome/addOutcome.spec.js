...
test.describe("Examination Category", () => {
  test("Add Examination", async ({ page }) => {
    ...
    for (const data of jsonData.PatientDetails) {
      ...
      await outcome.selectandAddClinicalItem('Sleep walking disorder');//This searches item and clicks on add button
      await page.waitForTimeout(2000)
      ...
      await outcomeExtraDetails.enterDateOfOutcome('26/04/2024');
      await outcomeExtraDetails.selectFrequency('1');
      await outcomeExtraDetails.enterClinicalItemNotes('Added Outcome Notes From Playwright');
     ...
     await page.pause();
      ...
      await outcomeExtraDetails.enterClinicalItemNotes('Updated Outcome Notes From Playwright');
      await outcomeExtraDetails.clickOnSave();
      await page.waitForTimeout(1000)
